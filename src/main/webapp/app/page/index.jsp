...
<body>
 <!--顶部快捷菜单-->
    <div class="shortcut_v2013 alink_v2013">
        <div class="w">
            <ul class="fl 1h">
                ...
                <li class="fl"><div class="menu_hd"><a href="app/page/user/login.jsp">请登录</a></div></li>
                <li class="fl"><i class="shortcut_s"></i></li>
                <li class="fl"><div class="menu_hd"><a href="app/page/user/rgst.jsp">免费注册</a></div></li>
            </ul>
            <ul class="fr 1h">
                            ...
                            <div class="cart_con_single">
                                <div class="single_pic">
                                    <a href="#" target="_blank" alt="兰蔻 (Lancome)根源补养洁颜啫哩 125ml">
                                        <img src="app/images/goods_img02.jpg" />
                                    </a>
                                </div>
    ...
    <script type="text/javascript" src="app/js/unslider.min.js"></script>
