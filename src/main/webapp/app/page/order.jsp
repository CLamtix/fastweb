...
<head>
	<base href="<%=basePath%>">
	<title>下单</title>
	<link type="text/css" rel="stylesheet" href="app/css/public.css"/>
	<link type="text/css" rel="stylesheet" href="app/css/base.css"/>
	<link type="text/css" rel="stylesheet" href="app/css/checkOut.css" />
</head>
            ...
            <ul class="fl 1h">
                <li class="fl">
                    <div class="menu">
                        <div class="menu_hd">
                            <a href="#">
                                <img src="app/images/top_phone_icon.png" width="12px" height="16px" />
                                手机锡货
                            </a>
                            <b><em></em></b></div>
                        <div class="menu_bd">
    ...
    <div class="header_2013">
        <div class="w">
            <div class="logo_v2013">
                <a href="#">
                    <img class="border_r" src="app/images/logo.jpg" width="120" height="50">
                    <img src="app/images/slogan.jpg" width="170" height="50">
                </a>
            </div>
            ...
            <div id="cart_box" class="cart_box">
                <a id="cart" class="cart_link" href="#" rel="nofollow">
                 <span class="text">去购物车结算</span>
                    <img src="app/images/shopping_icon.png" width="24" height="24" class="cart_gif">
                            ...
                            <div class="cart_con_single">
                                <div class="single_pic">
                                    <a href="#" target="_blank" alt="兰蔻 (Lancome)根源补养洁颜啫哩 125ml">
                                        <img src="app/images/goods_img01.jpg" />
                                    </a>
                                </div>
    ...
    <div class="clearfix xm-address-list" id="checkoutAddrList">
          <dl class="item" >
            ...
            <dd style="display:none">
             ...
             <span class="iconfont icon-add"><img src="app/images/add_cart.png" /></span> 
            使用新地址
        </div>
            </div>
...
<script type="text/javascript" src="js/checkout.min.js"></script> 
 ...
 <!--收货地址body部分结束-->
    ...
    <div class="promise_box">
    	<div class="w">
    		<ul>
        		<li><img src="app/images/promise_img01.jpg"><span>365天不打烊</span></li>
        		<li><img src="app/images/promise_img02.jpg"><span>无理由退换货</span></li>
        		<li><img src="app/images/promise_img03.jpg"><span>担保交易</span></li>
        		<li><img src="app/images/promise_img04.jpg"><span>先行赔付</span></li>
        		<li><img src="app/images/promise_img05.jpg"><span>支持定制</span></li>
        	</ul>
    	</div>
    </div>
    <div class="bottom-links">
        <ul class="clearfix cols">
            ...
            <li class="col">
                ...
                <ul class="clearfix bottom-links-items">
                    <li>
                        <img src="app/images/weixin_big.jpg" />
                    </li>
                </ul>
            </li>
            <li class="col">
                ...
                <ul class="clearfix bottom-links-items">
                    <li><img src="app/images/icon_sina.png" /><a href="#">新浪微博</a></li>
                    <li><img src="app/images/icon_tencent.png" /><a href="#">腾讯微博</a></li>
                    <li><img src="app/images/icon_dou.png" /><a href="#">豆瓣小站</a></li>
                    <li><img src="app/images/icon_weixin.png" /><a href="#">官方微信</a></li>
                </ul>
            </li>
    ...
    ©2013-2014 无锡太湖云电商网络科技发展有限公司   版权所有  更多模板：<a href="http://www.mycodes.net/" target="_blank">源码之家</a>
        ...
        <p>
            <a href="#"><img src="app/images/bottom_img01.png"></a>
            <a href="#"><img src="app/images/bottom_img02.png"></a>
            <a href="#"><img src="app/images/bottom_img03.png"></a>
            <a href="#"><img src="app/images/bottom_img04.png"></a>
            <a href="#"><img src="app/images/bottom_img05.png"></a>
            <a href="#"><img src="app/images/bottom_img06.png"></a>
            <a href="#"><img src="app/images/bottom_img07.png"></a>
            <a href="#"><img src="app/images/bottom_img08.png"></a>
            <a href="#"><img src="app/images/bottom_img09.png"></a>
        </p>
    </div>
    <!-- 底部 -->
    <div class="fixed-buttons">
        <ul>
            <li><a href="#" class="fixed-weixin"><img src="app/images/fixed_weixin.png" /><div class="weixin-pic"><img src="app/images/weixin_big.jpg"></div></a></li>
            <li><img id="imgBtn-to-top" src="app/images/back_top.png" /></li>
        </ul>
    </div>
    <script src="https://cdn.bootcss.com/jquery/3.3.1/jquery.min.js"></script>
    <script src="app/js/unslider.min.js" type="text/javascript"></script>
    <script src="app/js/index.js" type="text/javascript"></script>
	<script src="app/js/jquery_cart.js" type="text/javascript" ></script>
</body>
</html>
